...
class Admin
{
     ...
     *
     * This also helps in sorting the errors to get and display.
     *
    ...
    protected function sort_response($response)
    {
        ...
        if ($this->curl->get_error()) {
            ...
            if ($this->get_build_state() != 'production')
                $this->error = $this->get_raw_response_or_error();
            else
    ...
    /**
     * toggles between raw_response or response_error
     *
     * @return mixed
     */
    public function get_raw_response_or_error()
    {
        $err = (!empty($this->get_raw_response()) ? $this->get_raw_response() : $this->get_response_error());
        return (!empty($err) ? $err : null);
    }
    ...
    public function login($email, $password)
    {
        ...
        if (!$this->get_endpoint($url))//seems it didnt go well, return false because the get_endpoint processes it all
            return false;
...
public function header($page_title = '', $parent_folder = '')
{
    ...
    <head>
        ...
        <link href="<?php echo $parent_folder; ?>assets/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet"
              media="all">
        <link href="<?php echo $parent_folder; ?>assets/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet"
              media="all">
        <link href="<?php echo $parent_folder; ?>assets/mdi-font/css/material-design-iconic-font.min.css"
        ...
        <link href="<?php echo $parent_folder; ?>assets/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css"
              rel="stylesheet" media="all">
        ...
        <link href="<?php echo $parent_folder; ?>assets/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet"
              media="all">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p> <?php echo date('Y'); ?> Wave Us. Template by <a href="https://colorlib.com">Colorlib</a>.
                                    </p>
                                </div>
                            </div>
                        </div>
