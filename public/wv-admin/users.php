                       ...
                       <div class="row">
						...
						<div class="row">
							...
							<form action="<?php echo htmlentities($_SERVER["REQUEST_URI"]); ?>" method="post">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Data table - <?php echo $filter; ?> users (<?php echo $admin->count_users(1,$filter); ?>)</h3>
                                <?php
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <a href="add_user.php?type=user" class="au-btn au-btn-icon au-btn--green au-btn--small">
                                ...
                                <?php
                                    ...
                                    $data = $admin->get_users(1,$filter);
                                    $add = array(
                                        'order_count'=>'<span id="o_c-[id]" class="total-order-count-h"><i class="fas fa-spin fa-loader"></span>',
                                        'action'=>'<a href="user.php?id=[id]&type=user" class="btn btn-primary" title="view [fullname]">View</a>'
                                        );
                            ...
                            <script type="text/javascript">
                                ...
                                function sortCount(element,type){
                                    ...
                                    realId = realId[1];
                                    var _url = "ajax_get_user_total_order_count.php?user_id="+realId+"&user_type=user&request="+type;
                                    $.get(_url,function(){
                                    })
                                    .done(function(data){
                                        $('#'+_id).html(data);
