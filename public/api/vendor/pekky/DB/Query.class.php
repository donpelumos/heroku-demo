<?php
	...
	class Query extends DBCon{
		...
		*/
		...
		/**
		 * Clears the data for a new start
		 */
		public function clear_data(){
			...
			$this->_bindings = null;
			$this->query_txt = '';//Query text
		 	$this->general_obj = null;//holds either the query object or prepared statement object depending on the situation.
			$this->query_obj = null;//holds the query object
			$this->prepared_obj = null;//holds the prepared statement object when a prepared statement is successful.
			$this->prepared_txt = '';//holds the $query_txt text when using a prepared statement.			
		}
		 ...
		 * @return int
		 */
		public function get_last_err_no(){
		...
		*/
		 ...
		 * @return mixed
		 */
		protected function query($query,$token){
			$this->token = $token;
